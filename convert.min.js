...
const baseRules = [
    ...
    `DOMAIN,sub2.xian995.dpdns.org,${PROXY_GROUPS.REVERSE_API}`,
    `DOMAIN,new.xian995.dpdns.org,${PROXY_GROUPS.REVERSE_API}`,
    `DOMAIN,cli.xian995.dpdns.org,${PROXY_GROUPS.REVERSE_API}`,
...
function main(config) {
    const resultConfig = {
        proxies: (config.proxies || []).map((proxy) =>
            landing && LANDING_REGEX.test(proxy.name || "")
